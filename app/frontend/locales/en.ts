const en = {
  ...
  freedom: {
    ...
    chart: {
      ...
      today: 'Today',
      goal: 'Goal',
      unreachable: 'With these inputs your goal is beyond the 60-year horizon. Try raising the monthly contribution or trimming the objective.',
    },
    dividendChart: {
