const es = {
  ...
  freedom: {
    ...
    insights: {
      ...
      outOfHorizon: 'Más allá de 60 años',
    },
    progress: {
    ...
    chart: {
      ...
      today: 'Hoy',
      goal: 'Objetivo',
      unreachable: 'Con estos datos tu objetivo queda más allá del horizonte de 60 años. Prueba a subir el aporte mensual o a ajustar el objetivo.',
    },
    dividendChart: {
