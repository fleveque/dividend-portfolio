const es = {
  ...
  demo: {
    home: {
      title: 'Un recorrido en vivo por Quantic',
      intro: 'Esta es una cartera de ejemplo con holdings, dividendos y una proyecci\u00f3n de Camino a la libertad realistas. Todo funciona igual con tus propios datos cuando te registras.',
      freedomPitchTitle: 'Planifica tu propio camino',
      freedomPitchBody: 'Define tu aporte mensual y tu objetivo de dividendos. Quantic te muestra los a\u00f1os restantes, lo que falta por cubrir y c\u00f3mo el inter\u00e9s compuesto hace el trabajo pesado.',
      freedomPitchCta: 'Reg\u00edstrate gratis',
    },
    banner: {
  ...
  freedom: {
    ...
    intro: 'Calcula cuánto te falta para que tus dividendos cubran tu objetivo. Tu aporte y tu meta suben con la inflación, los rendimientos se reinvierten — el gráfico muestra cuándo el interés compuesto empieza a marcar la diferencia.',
    emptyState: 'Introduce tu aporte mensual y tu objetivo de dividendos para ver la proyección.',
    inputs: {
      title: 'Tu plan',
      help: 'Todas las cantidades están en dinero de hoy. Tanto los aportes como el objetivo se ajustan con la inflación en la proyección.',
      monthlyInvest: 'Aporte mensual',
      monthlyInvestHint: 'Lo que puedes sumar cada mes a tu cartera, en dinero de hoy.',
      monthlyObjective: 'Objetivo mensual de dividendos',
      monthlyObjectiveHint: 'El ingreso mensual por dividendos del que quieres vivir, en dinero de hoy.',
      inflation: 'Inflación estimada',
      inflationHint: 'Tasa anual de inflación. La media de largo plazo en la eurozona ronda el 2%.',
      yield: 'Rendimiento esperado',
      yieldHint: 'Rendimiento anual de la cartera. Por defecto, el actual de tu cartera.',
      yieldHintWithAuto: 'Sobrescribe el rendimiento proyectado. Rendimiento actual de la cartera: {{value}}%.',
      startYear: 'Año en que empezaste a invertir',
      startYearHint: 'Opcional. Extiende el gráfico hacia atrás para que veas el camino recorrido.',
      startYearHintFromDividends: 'Opcional. Tu primer dividendo registrado fue en {{value}}.',
      birthYear: 'Año de nacimiento',
      birthYearHint: 'Opcional. Añade una fila con tu edad al eje X del gráfico, para leer la línea temporal como capítulos de tu vida.',
      birthYearHintAge: 'Opcional. Este año cumples {{value}} — el gráfico mostrará tu edad en cada punto.',
      retirementAge: 'Edad de jubilación',
      retirementAgeHint: 'Opcional. Fuerza la distribución a esta edad, aunque no se haya alcanzado el objetivo de dividendos.',
      retirementAgeHintNoBirth: 'Opcional. Requiere el año de nacimiento para activarse.',
    },
    startingPoint: {
      title: 'Tu punto de partida',
      portfolioValue: 'Valor de la cartera',
      yield: 'Rendimiento usado',
      yieldOverride: 'Anulación activa',
      monthlyDividend: 'Dividendo mensual actual',
      monthlyDividendHint: 'Cartera × rendimiento / 12.',
    },
    insights: {
      eta: 'Tiempo para alcanzar el objetivo',
      finalNominal: 'Cartera al alcanzar el objetivo',
      finalReal: 'En dinero de hoy',
      finalRealHint: 'Equivalente ajustado por inflación.',
      yieldEarned: 'Rendimiento generado',
      yieldEarnedHint: 'Sobre {{value}} aportados.',
      outOfHorizon: 'Más allá de 80 años',
      yearsSustained: 'Ingreso real sostenido',
      yearsSustainedHint: 'Años hasta que tu ingreso mensual deje de seguir el ritmo de la inflación. Combina dividendos, intereses y ventas de capital.',
      capitalGone: 'Capital agotado en',
      capitalGoneHint: 'Años hasta que el capital total llegue a cero, incluidos los posteriores a la pérdida de poder adquisitivo, agotando lo que queda.',
      indefinitely: 'Indefinidamente',
    },
    progress: {
      todayLabel: 'Dividendos mensuales hoy frente al objetivo',
    },
    chart: {
      title: 'Tu proyección',
      growthTitle: 'Crecimiento de la cartera',
      growthSubtitle: 'Aportes acumulados frente al valor total de la cartera. La diferencia entre las dos líneas es el rendimiento compuesto que ganas por el camino.',
      contributions: 'Dinero que aportas',
      portfolio: 'Cartera total',
      year: 'Año',
      today: 'Hoy',
      goal: 'Objetivo',
      ageAxis: 'edad',
      unreachable: 'Con estos datos tu objetivo queda más allá del horizonte de 80 años. Prueba a subir el aporte mensual o a ajustar el objetivo.',
    },
    dividendChart: {
      title: 'Ingreso mensual por dividendos',
      subtitle: 'El día en que tu línea de ingresos cruza tu objetivo es el día en que tu cartera paga tus facturas.',
      income: 'Dividendo mensual',
      objective: 'Objetivo mensual',
    },
    capitalChart: {
      title: 'Capital total e ingreso mensual',
      subtitle: 'Suma de los tres bloques de capital (eje izquierdo) y el ingreso mensual que generan (eje derecho). Al alcanzar el objetivo dejas de reinvertir y retiras del capital lo necesario para mantener el objetivo ajustado por inflación: el capital baja, el ingreso se mantiene, hasta que el capital se agota.',
      total: 'Capital total',
      distribution: 'Distribución',
      income: 'Ingreso mensual',
      lossPoint: 'Pérdida de poder adquisitivo',
    },
    otherCapital: {
      toggle: 'Añadir otro capital (bonos, inmobiliario, fondos de crecimiento…)',
      help: 'Opcional. Añade capital que paga intereses (bonos, ahorros, inmobiliario) o que crece sin pagar ingresos (fondos índice, acciones de crecimiento).',
      interestCapital: 'Capital con intereses',
      interestCapitalHint: 'Bonos, inmobiliario, cuentas bancarias.',
      interestRate: 'Tipo de interés anual',
      interestRateHint: 'Interés anual sobre este capital.',
      reinvest: 'Reinvertir los intereses durante la acumulación',
      reinvestHint: 'Si está activado, los intereses se reinvierten en el capital. Si no, se cobran como ingreso y cuentan para tu objetivo.',
      growthCapital: 'Capital en crecimiento',
      growthCapitalHint: 'Fondos índice, acciones de crecimiento, sin ingresos recurrentes.',
      growthRate: 'Crecimiento anual esperado',
      growthRateHint: 'Tasa anual de revalorización del capital.',
    },
    table: {
      title: 'Detalle año a año',
      year: 'Año',
      contributions: 'Aportado',
      portfolio: 'Cartera',
      monthlyDividend: 'Dividendo mensual',
      objective: 'Objetivo (nominal)',
    },
    homeMini: {
      title: 'Camino a la libertad',
      progressLabel: 'Dividendos mensuales hoy',
      eta: 'Tiempo estimado restante',
      finalReal: 'Cartera objetivo (dinero de hoy)',
      cta: 'Abrir mi plan',
    },
    anonShowcase: {
      title: 'Camino a la libertad',
      description: 'Una calculadora motivacional que convierte tu cartera, tu aporte mensual y tu objetivo de dividendos en una proyección año a año, con inflación, rendimientos reinvertidos y un tiempo estimado honesto.',
      bullet1: 'Mide tu avance hacia el objetivo mensual de dividendos',
      bullet2: 'Reinversión de rendimientos e inflación dentro del cálculo',
      bullet3: 'Cartera final en términos nominales y en dinero de hoy',
      bullet4: 'Años, meses y días hasta tu libertad financiera',
      cta: 'Crea tu plan',
    },
  },
} as const
