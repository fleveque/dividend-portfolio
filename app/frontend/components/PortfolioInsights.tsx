...
export function PortfolioInsights({ hasStocks }: PortfolioInsightsProps) {
  const [isExpanded, setIsExpanded] = useState(false)
  const { data, isLoading, error, refetch, isFetching } = usePortfolioInsights(isExpanded && hasStocks)
