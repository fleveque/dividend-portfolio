        ...
        <div className="card">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-theme-elevated text-theme-muted">or</span>
            </div>
          </div>

          {/* Google Sign In - must be POST for OmniAuth CSRF protection */}
          <form action="/auth/google_oauth2" method="post">
            ...
            <button
              type="submit"
              className="flex items-center justify-center gap-3 w-full px-4 py-2.5 border border-theme rounded-lg
                         text-theme-secondary hover:bg-theme-muted transition-colors cursor-pointer"
            >
